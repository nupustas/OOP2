...
void Sorting(Container &grupe) {
    ...
    if (x == '1')
        grupe.sort([](const Stud &a, const Stud &b) { return a.Vardas < b.Vardas; });
    else if (x == '2')
        grupe.sort([](const Stud &a, const Stud &b) { return a.Pavarde < b.Pavarde; });
    else if (x == '3')
        grupe.sort([](const Stud &a, const Stud &b) { return a.galutinis > b.galutinis; });
    else
        grupe.sort([](const Stud &a, const Stud &b) { return a.galutinis < b.galutinis; });
}
